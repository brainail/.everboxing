...
public final class ToolFragments {
    ...
    public static boolean openFragment (
            final AppCompatActivity activity,
            final FragmentCreator target,
        ...
        if (! fragmentPopped && (null == fragmentManager.findFragmentByTag (tagIdentifier))) {
            ...
            if (! (targetFragment instanceof Fragment)) {
                return false;
            }
    ...
    public static boolean openDrawerFragment (final AppCompatActivity activity, final FragmentCreator target) {
        return openFragment (activity, target, true);
    }
     ...
     * THE SOFTWARE.
     */
    public static class FragmentCreator implements Tagable, Creatable {
