...
public class DrawerSectionHolder {
    ...
    View selfView;
    @BindView(R.id.drawer_section_text) TextView selfText;
    @BindView(R.id.drawer_section_icon) ImageView selfIcon;
    @BindView(R.id.drawer_section_notification) TextView selfNotifications;
