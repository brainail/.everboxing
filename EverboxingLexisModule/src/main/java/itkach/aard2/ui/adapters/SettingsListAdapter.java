...
public class SettingsListAdapter extends BaseAdapter implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public final static int POS_UI_THEME = 0;
    public final static int POS_REMOTE_CONTENT = 1;
    public final static int POS_FAV_RANDOM = 2;
    public final static int POS_USER_STYLES = 3;
    public final static int POS_CLEAR_CACHE = 4;
    public final static int POS_ABOUT = 5;
    ...
    private View getUserStylesView(View convertView, final ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            btnAdd.setImageDrawable(parent.getContext().getResources().getDrawable(android.R.drawable.ic_menu_help));
        ...
        for (int i = 0; i < userStyleNames.size(); i++) {
            ...
            btnDelete.setImageDrawable(parent.getContext().getResources().getDrawable(android.R.drawable.ic_menu_help));
    ...
    private View getAboutView(View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            copyrightIcon.setImageDrawable(parent.getContext().getResources().getDrawable(android.R.drawable.ic_menu_help));

            ImageView licenseIcon = (ImageView) view.findViewById(R.id.setting_about_license_icon);
            licenseIcon.setImageDrawable(parent.getContext().getResources().getDrawable(android.R.drawable.ic_menu_help));

            ImageView sourceIcon = (ImageView) view.findViewById(R.id.setting_about_source_icon);
            sourceIcon.setImageDrawable(parent.getContext().getResources().getDrawable(android.R.drawable.ic_menu_help));
