...
public class BaseArticleWebView extends BaseWebView {
    ...
    // static final class WebArticlesCacheOptions {
        ...
        // static final String DATABASE_PATH = "org.brainail.EverboxingLexisPaper.articles.db";
        // static final int CACHE_SIZE_BYTES = 8 * 1024 * 1024;
    // }

    public BaseArticleWebView (Context context) {
        this (context, null);
    }
