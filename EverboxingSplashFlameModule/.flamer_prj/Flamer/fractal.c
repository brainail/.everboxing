...
write_to_tiff (flame *fractal) {
    ...
    printf("Flame xres = %d, yres = %d\n", fractal->xres, fractal->yres);
...
int
convert_tiff_to_rgb(const char *filename, int *width, int *height, unsigned char *rgb)
{
...
main (int argc, char **argv) {
    ...
    char filename [100] = {0,};
    sprintf(filename, "/Users/brainail/Temp/flame_%lld.jpg", ms);
    argv [1] = "-f";
    argv [2] = filename;
    // argv [3] = "-p";
    // argv [4] = "/Users/brainail/Temp/co.txt";
    // argv [5] = "-c";
    // argv [6] = "/Users/brainail/Temp/cf.txt";
    argv [3] = "-v";
    argv [4] = "29";
    argv [5] = "-I";
    // <<< Init argv
