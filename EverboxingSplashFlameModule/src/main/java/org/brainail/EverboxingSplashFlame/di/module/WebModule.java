...
public class WebModule {
    ...
    WebChromeClient provideWebChromeClient () {
        return new DefaultWebChromeClient (mWebPage);
    }

    @Provides
    @PerFragment
    WebViewClient provideWebViewClient (@ActivityContext Navigator navigator) {
        return new DefaultWebViewClient (mWebPage, navigator);
    }
