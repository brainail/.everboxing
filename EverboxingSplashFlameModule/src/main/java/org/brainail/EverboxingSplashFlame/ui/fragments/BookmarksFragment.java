    ...
    public void onActivityCreated (@Nullable Bundle savedInstanceState) {
        ...
        AsyncTaskCompat.executeParallel(new AsyncTask<Void, Void, String> () {
            ...
            protected String doInBackground(Void... params) {
                ...
                File filePath = new File(file, "fractal_" + System.currentTimeMillis () + ".jpeg");
                final Point sizes = ToolPhone.realScreenSize (getContext ());
                ToolFractal.warmUp (filePath.getAbsolutePath (), sizes.x, sizes.y, 10);
            ...
            protected void onPostExecute (String path) {
                ...
                ToolUI.showToast (BookmarksFragment.this, "We are freaky guys (.)*(.)");
