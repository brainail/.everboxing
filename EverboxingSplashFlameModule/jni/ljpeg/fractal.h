...
#define LOGI(x) __android_log_print(ANDROID_LOG_DEBUG, "__EverboxingNative", "%s", x)
#define LOGII(x, y) __android_log_print(ANDROID_LOG_DEBUG, "__EverboxingNative", "%s %d", x, y)
#define LOGIS(x, y) __android_log_print(ANDROID_LOG_DEBUG, "__EverboxingNative", "%s %s", x, y)
#define LOGE(x) __android_log_print(ANDROID_LOG_ERROR, "__EverboxingNative", "%s", x)
#define LOGES(x, y) __android_log_print(ANDROID_LOG_ERROR, "__EverboxingNative", "%s %s", x, y)

#define JNIFUNCF(cls, name, vars...) Java_org_brainail_EverboxingSplashFlame_utils_tool_ ## cls ## _ ## name(JNIEnv* env, vars)
